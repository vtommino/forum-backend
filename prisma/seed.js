...
const postData = [
  {
    userId: 1,
    threadId: 1,
    postTitle: "Swimming pool🏊",
    postDescription: "The swimming pool is open from 6am to 10pm daily.",
  ...
  },
  {
    userId: 2,
    threadId: 1,
    postTitle: "Auto Parking 🅿️🚘",
    postDescription:
      "The condominium provides an auto parking system for residents.",
    postVideoLink: "https://www.youtube.com/watch?v=GlMUvUuR7uU",
    postMapLink: "https://maps.app.goo.gl/upavFwvH3wM5PpmV8",
    postCreatedAt: new Date().toISOString(),
    postUpdatedAt: new Date().toISOString(),
  },
  {
    ...
    postDescription:
      "The common meeting room is available for residents to book for meetings and events.",
    postVideoLink: "https://www.youtube.com/watch?v=GlMUvUuR7uU",
    postMapLink: "https://maps.app.goo.gl/upavFwvH3wM5PpmV8",
    postCreatedAt: new Date().toISOString(),
    postUpdatedAt: new Date().toISOString(),
  },
  {
    userId: 4,
    threadId: 1,
    postTitle: "Garbage Room ♻️",
    postDescription:
      "The garbage room is located on the ground floor near the service elevator.",
    postVideoLink: "https://www.youtube.com/watch?v=GlMUvUuR7uU",
    postMapLink: "https://maps.app.goo.gl/upavFwvH3wM5PpmV8",
    postCreatedAt: new Date().toISOString(),
    postUpdatedAt: new Date().toISOString(),
  },
  {
    userId: 5,
    threadId: 1,
    postTitle: "Juristic Opening Hours 🏪",
    postDescription:
      "The juristic office is open from 9am to 6pm, Monday to Sunday.",
    postVideoLink: "https://www.youtube.com/watch?v=GlMUvUuR7uU",
    postMapLink: "https://maps.app.goo.gl/upavFwvH3wM5PpmV8",
    postCreatedAt: new Date().toISOString(),
    postUpdatedAt: new Date().toISOString(),
  },
  {
    userId: 3,
    threadId: 1,
    postTitle: "Vending Machine 🧃",
    postDescription: "   A vending machine is located in the lobby area.",
    postVideoLink: "https://www.youtube.com/watch?v=GlMUvUuR7uU",
    postMapLink: "https://maps.app.goo.gl/upavFwvH3wM5PpmV8",
    postCreatedAt: new Date().toISOString(),
    postUpdatedAt: new Date().toISOString(),
